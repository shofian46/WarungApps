...
class TentangDeveloper : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    generatePDFBtn = findViewById(R.id.btnPDF)

    secondActbutton.setOnClickListener {
      val dialIntent = Intent(Intent.ACTION_DIAL)
      dialIntent.data = Uri.parse("tel:" + "085591467429")
      startActivity(dialIntent)
    }
// on below line we are initializing our bitmap and scaled bitmap.
    bmp = BitmapFactory.decodeResource(resources, R.drawable.android_logo__1_)
  ...
  fun generatePDF() {
    ...
    var desc: String = getString(R.string.about)
    ...
    canvas.drawText("Android Developer Extraordinare", 209F, 100F, title)
    canvas.drawText("Shofian Al Fikri", 209F, 80F, title)
